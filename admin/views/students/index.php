<?php
// require_once __DIR__ . '/../../models/Student.php'; // Already loaded by index.php
        ...
        <div class="d-flex gap-2">
            ...
            <form action="index.php" method="GET" class="d-flex gap-2 mb-0">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="search" id="searchInput" placeholder="Search by name or phone..." 
